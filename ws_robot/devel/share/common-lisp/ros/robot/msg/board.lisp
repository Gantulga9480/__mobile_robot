...
(cl:defmethod cl:initialize-instance :after ((m <board>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'board)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot-msg:<board> is deprecated: use robot-msg:board instead.")))

(cl:ensure-generic-function 'robot_x-val :lambda-list '(m))
(cl:defmethod robot_x-val ((m <board>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot-msg:robot_x-val is deprecated.  Use robot-msg:robot_x instead.")
  (robot_x m))

(cl:ensure-generic-function 'robot_y-val :lambda-list '(m))
(cl:defmethod robot_y-val ((m <board>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot-msg:robot_y-val is deprecated.  Use robot-msg:robot_y instead.")
  (robot_y m))

(cl:ensure-generic-function 'robot_dir-val :lambda-list '(m))
(cl:defmethod robot_dir-val ((m <board>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot-msg:robot_dir-val is deprecated.  Use robot-msg:robot_dir instead.")
  (robot_dir m))
